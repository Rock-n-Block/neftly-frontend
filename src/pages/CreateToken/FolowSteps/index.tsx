...
const FolowSteps: React.FC<IFolowStepsProps> = ({ className }) => {
  return (
    <div className={cn(className, styles.steps)}>
      ...
      <div className={styles.list}>
        <div className={cn(styles.item, styles.done)}>
          ...
          <button type="button" className={cn('button done', styles.button)}>
            Done
          </button>
        </div>
        <div className={styles.item}>
          ...
          <button type="button" className={cn('button disabled', styles.button)}>
            Start now
          </button>
        </div>
        <div className={styles.item}>
          ...
          <button type="button" className={cn('button loading', styles.button)}>
        ...
        <div className={cn(styles.item, styles.error)}>
          ...
          <button type="button" className={cn('button error', styles.button)}>
            Failed
          </button>
        </div>
        <div className={styles.item}>
