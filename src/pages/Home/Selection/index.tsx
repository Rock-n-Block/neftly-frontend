      ...
      <div className={cn('container', styles.container)}>
        <div className={styles.row}>
          <div className={styles.col}>
            {items.map(
              (x, index) =>
                index === 0 && (
                  <Link className={styles.card} to={x.url} key={nextId()}>
          ...
          <div className={styles.col}>
            {items.map(
              (x, index) =>
                index > 0 && (
                  <Link className={styles.item} to={x.url} key={nextId()}>
                    <div className={styles.preview}>
                      <img srcSet={`${x.image2x} 2x`} src={x.image} alt="Selection" />
                    </div>
                    <div className={styles.description}>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.list}>
            {users.map((x) => (
              <div className={styles.user} key={nextId()}>
                <div className={styles.avatar}>
                  <img src={x.avatar} alt="Avatar" />
                ...
                <div className={styles.description}>
                  ...
                  {/* TODO: посмотреть, что за dangerous */}
