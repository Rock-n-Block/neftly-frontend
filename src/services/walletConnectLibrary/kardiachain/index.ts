...
import { IConnectorMessage, TChainId } from '../interface';
  ...
  public getAccounts(): Observable<any> {
    ...
    return new Observable((observer) => {
      if (this.connector && this.connector.isKaiWallet) {
        ...
        this.connector.on('chainChanged', async (chainId: TChainId) => {
        ...
        this.connector.on('accountsChanged', (address: Array<string>) => {
          if (
            (this.currentAddr && address[0].toUpperCase() !== this.currentAddr.toUpperCase()) ||
