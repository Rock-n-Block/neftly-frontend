  ...
  return (
    <div className={cn(styles.titleDropdown, className)}>
      <OutsideClickHandler onOutsideClick={handleClose}>
        ...
        }} onClick={() => setIsOpen(prevState => !prevState)} className={styles.selected}>{value.label}<img
          src={iconArrowDownBlue} alt="" className={cn(styles.selectedImg, {[styles.selectedImgOpen]: isOpen})}/></div>
